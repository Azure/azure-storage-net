...
namespace Microsoft.WindowsAzure.Storage.Table
{
    ...
    public class TableQueryableTests : TableTestBase
    {
        ...
        public void TableQueryableMultipleContexts()
        {
            ...
            TestHelper.VerifyHeaderWasSent(opContext2.UserHeaders.Keys.First(), opContext2.UserHeaders[opContext2.UserHeaders.Keys.First()], AzureStorageSelectors.TableTraffic().IfHostNameContains(currentTable.ServiceClient.Credentials.AccountName), act);
            TestHelper.VerifyHeaderWasSent(opContext.UserHeaders.Keys.First(), String.Empty, AzureStorageSelectors.TableTraffic().IfHostNameContains(currentTable.ServiceClient.Credentials.AccountName), act);
        }
            ...
            TestHelper.ExecuteMethodWithRetry(
                ...
                new[] {
                    ...
                    PerformanceBehaviors.InsertUpstreamNetworkDelay(10000,
                                                                    AzureStorageSelectors.TableTraffic().IfHostNameContains(currentTable.ServiceClient.Credentials.AccountName),
