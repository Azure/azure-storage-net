// -----------------------------------------------------------------------------------------
// <copyright file="EncryptedBaseEntity.cs" company="Microsoft">
...
namespace Microsoft.WindowsAzure.Storage.Table.Entities
{
    ...
    {
        public EncryptedBaseEntity()
        {
        }

        public EncryptedBaseEntity(string pk, string rk)
            : base(pk, rk)
        {
        }
        ...
        {
            Assert.AreEqual(this.foo, string.Empty);
