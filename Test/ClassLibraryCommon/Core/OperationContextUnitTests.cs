...
namespace Microsoft.WindowsAzure.Storage.Core
{
    ...
    public class OperationContextUnitTests : TestBase
    {
        ...
        public void OpContextTestClientRequestIDOnBlob()
        {
            ...
            TestHelper.VerifyHeaderWasSent("x-ms-client-request-id", uniqueID, AzureStorageSelectors.BlobTraffic().IfHostNameContains(blobClient.Credentials.AccountName), act);
        ...
        public void OpContextTestUserHeadersOnBlob()
        {
            ...
            TestHelper.VerifyHeaderWasSent(ctx.UserHeaders.Keys.First(), ctx.UserHeaders[ctx.UserHeaders.Keys.First()], AzureStorageSelectors.BlobTraffic().IfHostNameContains(blobClient.Credentials.AccountName), act);
