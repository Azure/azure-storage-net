// -----------------------------------------------------------------------------------------
// <copyright file="ComplexEntityWithNestedComplexProperties.cs" company="Microsoft">
...
namespace Microsoft.Azure.Storage.Table.Entities
{
    ...
    {
        public ComplexEntityWithNestedComplexProperties InnerComplexEntityWithNestedComplexProperties { get; set; }

        public ComplexEntity ComplexEntity { get; set; }

        public ShapeEntity ShapeEntity { get; set; }

        [IgnoreProperty]
        public Guid IgnoredProperty { get; set; }
