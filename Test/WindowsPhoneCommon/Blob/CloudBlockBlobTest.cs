    ...
    public class CloudBlockBlobTest : BlobTestBase
    {
        ...
        public async Task CloudBlockBlobUploadFromStreamWithAccessConditionAsync()
        {
            ...
            try
            {
                ...
                await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, null, accessCondition, operationContext, true, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, null, accessCondition, operationContext, true, false, 0);
                ...
                await TestHelper.ExpectedExceptionAsync(
                    async () => await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, null, accessCondition, operationContext, true, true, 0),
                    operationContext,
                ...
                await TestHelper.ExpectedExceptionAsync(
                    ...
                    HttpStatusCode.PreconditionFailed);
                await TestHelper.ExpectedExceptionAsync(
                    async () => await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, null, accessCondition, operationContext, true, false, 0),
                    operationContext,
                    "Uploading a blob on top of an non-existing blob should fail when the ETag doesn't match",
                    HttpStatusCode.PreconditionFailed);
                accessCondition = AccessCondition.GenerateIfNoneMatchCondition(blob.Properties.ETag);
        ...
        public async Task CloudBlockBlobUploadFromStreamWithNonSeekableStreamAsync()
        {
            ...
            try
            {
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, false, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, false, true, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, false, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, false, false, 1024);
            }
            finally
            {
                container.DeleteAsync().Wait();
        ...
        public async Task CloudBlockBlobUploadFromStreamAsync()
        {
            ...
            try
            {
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, true, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, true, true, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, true, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, null, null, null, true, false, 1024);
            }
            finally
            {
                container.DeleteAsync().Wait();
        ...
        public async Task CloudBlockBlobUploadFromStreamLengthSinglePutAsync()
        {
            ...
            try
            {
                ...
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, true, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, true, true, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, false, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, false, true, 1024);

                // Exclude last byte
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024 - 1, null, null, true, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024 - 1, null, null, true, true, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024 - 1, null, null, false, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024 - 1, null, null, false, true, 1024);
            
                // Upload exact amount
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024, null, null, true, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024, null, null, true, true, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024, null, null, false, true, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024, null, null, false, true, 1024);
            }
            finally
            {
                container.DeleteAsync().Wait();
        ...
        public async Task CloudBlockBlobUploadFromStreamLengthAsync()
        {
            ...
            {
                // Upload 2MB of 5MB stream
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, true, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, true, false, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, false, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 2 * 1024 * 1024, null, null, false, false, 1024);

                // Exclude last byte
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024 - 1, null, null, true, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024 - 1, null, null, true, false, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024 - 1, null, null, false, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024 - 1, null, null, false, false, 1024);

                // Upload exact amount
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024, null, null, true, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024, null, null, true, false, 1024);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 5 * 1024 * 1024, null, null, false, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 5 * 1024 * 1024, 4 * 1024 * 1024, null, null, false, false, 1024);
            }
            finally
            {
                container.DeleteAsync().Wait();
        ...
        public async Task CloudBlockBlobUploadFromStreamInvalidLengthAsync()
        {
            ...
            try
            {
                await TestHelper.ExpectedExceptionAsync<ArgumentOutOfRangeException>(
                        async () => await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, 2 * 1024 * 1024 + 1, null, null, true, true, 0),
                        "The given stream does not contain the requested number of bytes from its given position.");

                await TestHelper.ExpectedExceptionAsync<ArgumentOutOfRangeException>(
                        async () => await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, 2 * 1024 * 1024 - 1023, null, null, true, true, 1024),
                        "The given stream does not contain the requested number of bytes from its given position.");

                await TestHelper.ExpectedExceptionAsync<ArgumentOutOfRangeException>(
                        async () => await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, 2 * 1024 * 1024 + 1, null, null, false, true, 0),
                        "The given stream does not contain the requested number of bytes from its given position.");

                await TestHelper.ExpectedExceptionAsync<ArgumentOutOfRangeException>(
                        async () => await this.CloudBlockBlobUploadFromStreamAsync(container, 2 * 1024 * 1024, 2 * 1024 * 1024 - 1023, null, null, false, true, 1024),
                        "The given stream does not contain the requested number of bytes from its given position.");
            }
            finally
            {
        ...
        public async Task CloudBlockBlobParallelUploadFromStreamAsync()
        {
            ...
            try
            {
                await this.CloudBlockBlobUploadFromStreamAsync(container, 16 * 1024 * 1024, null, null, null, true, false, 0);
                await this.CloudBlockBlobUploadFromStreamAsync(container, 16 * 1024 * 1024, null, null, null, true, false, 1024);
            }
            finally
            {
                container.DeleteAsync().Wait();
        ...
        private async Task CloudBlockBlobUploadFromStreamAsync(CloudBlobContainer container, int size, long? copyLength, AccessCondition accessCondition, OperationContext operationContext, bool seekableSourceStream, bool allowSinglePut, int startOffset)
        {
