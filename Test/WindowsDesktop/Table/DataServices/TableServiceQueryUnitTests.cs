...
namespace Microsoft.WindowsAzure.Storage.Table.DataServices
{
    ...
    public class TableServiceQueryUnitTests : TableTestBase
    {
        ...
        [TestMethod]
        [Description("TableServiceQuery Execute Sync against Secondary")]
        ...
        private void DoTableServiceQueryExecuteWithTake(TablePayloadFormat format)
        {
            CloudTableClient tableClient = GenerateCloudTableClient();
            TableServiceContext ctx = tableClient.GetTableServiceContext();
            SetPayloadFormatOnDataServiceContext(ctx, format, tableClient);
        ...
        private void DoTableServiceQueryExecuteSegmentedBasicSync(TablePayloadFormat format)
        {
            CloudTableClient tableClient = GenerateCloudTableClient();
            TableServiceContext ctx = tableClient.GetTableServiceContext();
            SetPayloadFormatOnDataServiceContext(ctx, format, tableClient);
