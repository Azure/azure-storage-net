...
namespace Microsoft.WindowsAzure.Storage.Blob
{
    ...
    internal sealed class ParallelDownloadStream : Stream
    {
        ...
        /// <summary>
        /// The maximum allowed time between write calls to the stream.
        /// </summary>
        private const int MAX_IDLE_TIME_MS = 120000;

        /// <summary>
        /// A <see cref="CancellationToken"/> which fires if the stream has
        /// not been written to since <see cref="MAX_IDLE_TIME_MS"/>
        /// </summary>
        ...
        public ParallelDownloadStream(MemoryMappedViewStream downloadStream)
        {
            ...
            this.cts = new CancellationTokenSource(MAX_IDLE_TIME_MS);
        }

        public override Task WriteAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken)
        {
            this.cts.CancelAfter(MAX_IDLE_TIME_MS);
