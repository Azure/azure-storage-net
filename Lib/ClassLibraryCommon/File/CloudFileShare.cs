...
namespace Microsoft.Azure.Storage.File
{
    ...
    public partial class CloudFileShare
    {
        ...
        {
            return CancellableAsyncResultTaskWrapper.Create(token => CreateAsync(options, operationContext, token), callback, state);
        }
        ...
        {
            return CancellableAsyncResultTaskWrapper.Create(token => this.ExistsAsync(options, operationContext, token), callback, state);
        }
        ...
        {
            return CancellableAsyncResultTaskWrapper.Create(token => this.GetStatsAsync(options, operationContext, token), callback, state);
        }
        ...
        {
            RESTCommand<CloudFileShare> putCmd = new RESTCommand<CloudFileShare>(this.ServiceClient.Credentials, this.StorageUri, this.ServiceClient.HttpClient);
        ...
        private RESTCommand<FileSharePermissions> GetPermissionsImpl(AccessCondition accessCondition, FileRequestOptions options)
        {
            ...
            RESTCommand<FileSharePermissions> getCmd = new RESTCommand<FileSharePermissions>(this.ServiceClient.Credentials, this.StorageUri, this.ServiceClient.HttpClient);
        ...
        {
            RESTCommand<ShareStats> retCmd = new RESTCommand<ShareStats>(this.ServiceClient.Credentials, this.StorageUri, this.ServiceClient.HttpClient);
