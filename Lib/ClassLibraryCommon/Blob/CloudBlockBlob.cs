...
namespace Microsoft.Azure.Storage.Blob
{
    ...
    public partial class CloudBlockBlob : CloudBlob, ICloudBlob
    {
        ...
        {
            return this.PutBlockAsync(blockId, blockData, contentMD5, default(AccessCondition), default(BlobRequestOptions), default(OperationContext), default(AggregatingProgressIncrementer), CancellationToken.None);
        }
        ...
        {
            return this.PutBlockAsync(blockId, blockData, contentMD5, default(AccessCondition), default(BlobRequestOptions), default(OperationContext), default(AggregatingProgressIncrementer), cancellationToken);
        }
        ...
        {
            return this.PutBlockAsync(blockId, blockData, contentMD5, accessCondition, options, operationContext, default(AggregatingProgressIncrementer), CancellationToken.None);
        }
        ...
        {
            return this.PutBlockAsync(blockId, blockData, contentMD5, accessCondition, options, operationContext, default(AggregatingProgressIncrementer), cancellationToken);
        }
        ...
        /// </remarks>
        [DoesServiceRequest]
        private string StartCopy(CloudBlockBlob source, string contentMD5, bool syncCopy,  StandardBlobTier? standardBlockBlobTier, RehydratePriority? rehydratePriority, AccessCondition sourceAccessCondition = null, AccessCondition destAccessCondition = null, BlobRequestOptions options = null, OperationContext operationContext = null)
        {
            return this.StartCopy(CloudBlob.SourceBlobToUri(source), contentMD5, syncCopy, default(PremiumPageBlobTier?), standardBlockBlobTier, rehydratePriority, sourceAccessCondition, destAccessCondition, options, operationContext);
        }
#endif
        /// <summary>
        ...
        {
            return this.StartCopyAsync(source, default(string) /* contentMD5 */, false /* incrementalCopy */, false /* syncCopy */, standardBlockBlobTier, rehydratePriority, sourceAccessCondition, destAccessCondition, options, operationContext, cancellationToken);
        }
