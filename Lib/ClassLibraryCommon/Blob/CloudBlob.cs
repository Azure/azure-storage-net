...
namespace Microsoft.Azure.Storage.Blob
{
    ...
    public partial class CloudBlob : IListBlobItem
    {
        ...
        {
            return this.StartCopy(source, default(PremiumPageBlobTier?), default(RehydratePriority?), sourceAccessCondition, destAccessCondition, options, operationContext);
        }
        ...
        /// </remarks>
        [DoesServiceRequest]
        internal virtual string StartCopy(Uri source, PremiumPageBlobTier? premiumPageBlobTier, RehydratePriority? rehydratePriority, AccessCondition sourceAccessCondition, AccessCondition destAccessCondition, BlobRequestOptions options, OperationContext operationContext)
        {
            return this.StartCopy(source, default(string) /* contentMD5 */, false /* syncCopy */, premiumPageBlobTier, rehydratePriority, sourceAccessCondition, destAccessCondition, options, operationContext);
        }
        ...
        /// </remarks>
        [DoesServiceRequest]
        internal virtual string StartCopy(Uri source, string contentMD5, bool syncCopy, PremiumPageBlobTier? premiumPageBlobTier, RehydratePriority? rehydratePriority, AccessCondition sourceAccessCondition, AccessCondition destAccessCondition, BlobRequestOptions options, OperationContext operationContext)
        {
        ...
        {
            return CancellableAsyncResultTaskWrapper.Create(token => this.StartCopyImplAsync(source, contentMD5, incrementalCopy, syncCopy, premiumPageBlobTier, default(RehydratePriority?), sourceAccessCondition, destAccessCondition, options, operationContext, token), callback, state);
