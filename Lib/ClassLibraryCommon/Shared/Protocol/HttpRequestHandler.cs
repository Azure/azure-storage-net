...
namespace Microsoft.Azure.Storage.Shared.Protocol
{
    ...
    internal static partial class HttpRequestHandler
    {
        ...
        {
            SetHeader(request, Constants.ContentLengthElement, contentLength.ToString());
        }

        internal static void SetContentType(HttpRequestMessage request, string contentType)
        {
            SetHeader(request, Constants.ContentTypeElement, contentType);
        }

        internal static void SetCacheControl(HttpRequestMessage request, string cacheControl)
        {
            SetHeader(request, Constants.CacheControlElement, cacheControl);
        }
        ...
        {
            SetHeader(request, Constants.ContentEncodingElement, cacheControl);
        }
