// -----------------------------------------------------------------------------------------
// <copyright file="FileReadStreamHelper.cs" company="Microsoft">
...
namespace Microsoft.WindowsAzure.Storage.File
{
    ...
    /// <summary>
    /// FileReadStream class is based on Stream, but all RT APIs need to return
    ...
    /// </summary>
    internal sealed class FileReadStreamHelper : IRandomAccessStreamWithContentType
    {
        private FileReadStream originalStream;
        ...
        /// <summary>
        /// This operation is not supported in FileReadStreamHelper.
        /// </summary>
