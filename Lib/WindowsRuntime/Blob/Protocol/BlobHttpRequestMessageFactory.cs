...
namespace Microsoft.Azure.Storage.Blob.Protocol
{
    ...
    internal static class BlobHttpRequestMessageFactory
    {
        ...
        {
            return BlobHttpRequestMessageFactory.CopyFrom(uri, timeout, source, new Checksum(md5: default(string), crc64: default(string)), incrementalCopy, false /* syncCopy */, null /* pageBlobTier */, sourceAccessCondition, destAccessCondition, content, operationContext, canonicalizer, credentials);
        }
