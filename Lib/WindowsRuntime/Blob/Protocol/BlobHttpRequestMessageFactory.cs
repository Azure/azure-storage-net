...
namespace Microsoft.WindowsAzure.Storage.Blob.Protocol
{
    ...
    internal static class BlobHttpRequestMessageFactory
    {
        ...
        /// <param name="accessCondition">The access condition to apply to the request.</param>
        /// <returns>A web request to use to perform the operation.</returns>
        public static StorageRequestMessage SetBlobTier(Uri uri, int? timeout, string premiumBlobTier, AccessCondition accessCondition, HttpContent content, OperationContext operationContext, ICanonicalizer canonicalizer, StorageCredentials credentials)
        {
            UriQueryBuilder builder = new UriQueryBuilder();
