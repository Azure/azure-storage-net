...
namespace Microsoft.Azure.Storage.Blob
{
    ...
    public partial class CloudBlockBlob : CloudBlob, ICloudBlob
    {
        ...
        {
            return this.StartCopyAsync(CloudBlob.SourceBlobToUri(source), Checksum.None, syncCopy, default(PremiumPageBlobTier?), sourceAccessCondition, destAccessCondition, options, operationContext, cancellationToken);
        }
        ...
        /// </remarks>
        [DoesServiceRequest]
        private Task<string> StartCopyAsync(CloudBlockBlob source, Checksum contentChecksum, bool syncCopy, AccessCondition sourceAccessCondition, AccessCondition destAccessCondition, BlobRequestOptions options, OperationContext operationContext, CancellationToken cancellationToken)
        {
            return this.StartCopyAsync(CloudBlob.SourceBlobToUri(source), contentChecksum, syncCopy, default(PremiumPageBlobTier?), sourceAccessCondition, destAccessCondition, options, operationContext, cancellationToken);
        }
