...
namespace Microsoft.Azure.Storage.Blob
{
    ...
    public partial class CloudBlobContainer
    {
        ...
        {
            return CreateAsync(accessType, null /* encryptionScopeOptions */, options, operationContext, CancellationToken.None);
        }
        ...
        /// <returns>A <see cref="Task"/> that represents an asynchronous action.</returns>
        [DoesServiceRequest]
        public virtual Task CreateAsync(BlobContainerPublicAccessType accessType, BlobContainerEncryptionScopeOptions encryptionScopeOptions, BlobRequestOptions options, OperationContext operationContext, CancellationToken cancellationToken)
        {
...
#pragma warning restore 618
        ...
        private RESTCommand<AccountProperties> GetAccountPropertiesImpl(BlobRequestOptions requestOptions)
        {
            ...
            retCmd.BuildRequest = (cmd, uri, builder, cnt, serverTimeout, ctx) => ContainerHttpRequestMessageFactory.GetAccountProperties(uri, serverTimeout, cnt, ctx, this.ServiceClient.GetCanonicalizer(), this.ServiceClient.Credentials);
