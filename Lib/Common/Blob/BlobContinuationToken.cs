...
, IXmlSerializable
#endif
    {
        ...
        private string type = Constants.ContinuationConstants.BlobType;

        /// <summary>
        /// Gets or sets the version for continuing results for <see cref="ICloudBlob"/> enumeration operations.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the type element (blob, queue, table, file) for continuing results for <see cref="ICloudBlob"/> enumeration operations.
        /// </summary>
        ...
        private string Type
        {
            ...
            {
                this.type = value;
                if (this.type != Constants.ContinuationConstants.BlobType)
                {
