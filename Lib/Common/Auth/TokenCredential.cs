...
namespace Microsoft.WindowsAzure.Storage.Auth
{
    ...
    public sealed class TokenCredential
    {
        ...
        /// </summary>
        /// <param name="token">Value of the token credential.</param>
    ...
    public sealed class TokenCredential: IDisposable
    {
        ...
        /// </summary>
        public void Dispose() { this.timer.Dispose(); this.cancellationTokenSource.Cancel(); }
        ...
        private async void RenewTokenAsync(Object state)
        {
            try
            {
                var newTokenAndFrequency = await this.renewTokenFuncAsync(state, this.cancellationTokenSource.Token);
