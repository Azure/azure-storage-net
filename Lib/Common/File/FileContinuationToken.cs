//-----------------------------------------------------------------------
// <copyright file="FileContinuationToken.cs" company="Microsoft">
...
namespace Microsoft.WindowsAzure.Storage.File
{
    ...
    /// </summary>
    /// <remarks><see cref="FileContinuationToken"/> continuation tokens are used in methods that return a <see cref="FileResultSegment"/> object, such as <see cref="CloudFileDirectory.ListFilesAndDirectoriesSegmented(FileContinuationToken)"/>.</remarks>
...
, IXmlSerializable
#endif
    {
        ...
        private string type = Constants.ContinuationConstants.FileType;

        /// <summary>
        /// Gets or sets the version for continuing results for <see cref="CloudFile"/> enumeration operations.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the type element (blob, queue, table, file) for continuing results for <see cref="CloudFile"/> enumeration operations.
        /// </summary>
        ...
        private string Type
        {
            ...
            {
                this.type = value;
                if (this.type != Constants.ContinuationConstants.FileType)
                {
        ...
        /// <summary>
        /// Gets or sets the next marker for continuing results for <see cref="CloudFile"/> enumeration operations.
        /// </summary>
